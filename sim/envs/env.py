...
class BaseEnv(gym.Env):
    ...
    def reset(
        ...
        *,
        ...
        deformed_state_path: Optional[str | Path] = None,
        ...
        if deformed_state_path is not None:
            from ..utils.deformation_bridge import DeformationBridge

            metadata = DeformationBridge.import_to_real2sim(self, deformed_state_path)
            reset_info['deformed_state'] = metadata
        else:
